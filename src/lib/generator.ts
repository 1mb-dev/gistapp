...
function sectionFooter(meta: SpecMeta): string {
  return `---\n\n**Generated by [Gist](https://gist.1mb.dev)** — [create your own build-ready spec](https://gist.1mb.dev) | ${meta.complexityTier} tier | ${meta.generated}`;
}
