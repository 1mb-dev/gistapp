...
- The landing page and spec page present the spec as the start of an AI build session, with the
  checkpoint model stated up front
- Complexity tier now appears in the spec footer, alongside the generation date

### Removed

- The `## Meta` header block from generated specs; specs now open on the summary
